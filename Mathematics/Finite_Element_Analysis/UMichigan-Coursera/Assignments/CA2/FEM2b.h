...
double N1prime(double xi){
  return -1./2.;
}

double N2prime(double xi){
  return 1./2.;
}
...
double FEM<dim>::basis_function(unsigned int node, double xi_1, double xi_2, double xi_3){
  ...
  //EDIT
  if(node == 0){
    value = N1(xi_1)*N1(xi_2)*N1(xi_3);
  } else if(node == 1){
    value = N2(xi_1)*N1(xi_2)*N1(xi_3);
  } else if(node == 2){
    value = N1(xi_1)*N2(xi_2)*N1(xi_3);
  } else if(node == 3){
    value = N1(xi_1)*N1(xi_2)*N2(xi_3);
  } else if(node == 4){
    value = N2(xi_1)*N2(xi_2)*N1(xi_3);
  } else if(node == 5){
    value = N2(xi_1)*N1(xi_2)*N2(xi_3);
  } else if(node == 6){
    value = N1(xi_1)*N2(xi_2)*N2(xi_3);
  } else if(node == 7){
    value = N2(xi_1)*N2(xi_2)*N2(xi_3);
  } 
...
std::vector<double> FEM<dim>::basis_gradient(unsigned int node, double xi_1, double xi_2, double xi_3){
  ...
  //EDIT
  if(node == 0){
    values[0] = N1prime(xi_1)*N1(xi_2)*N1(xi_3);
    values[1] = N1(xi_1)*N1prime(xi_2)*N1(xi_3);
    values[2] = N1(xi_1)*N1(xi_2)*N1prime(xi_3);
  } else if(node == 1){
    values[0] = N2prime(xi_1)*N1(xi_2)*N1(xi_3);
    values[1] = N2(xi_1)*N1prime(xi_2)*N1(xi_3);
    values[2] = N2(xi_1)*N1(xi_2)*N1prime(xi_3);
  } else if(node == 2){
    values[0] = N1prime(xi_1)*N2(xi_2)*N1(xi_3);
    values[1] = N1(xi_1)*N2prime(xi_2)*N1(xi_3);
    values[2] = N1(xi_1)*N2(xi_2)*N1prime(xi_3);
  } else if(node == 3){
    values[0] = N1prime(xi_1)*N1(xi_2)*N2(xi_3);
    values[1] = N1(xi_1)*N1prime(xi_2)*N2(xi_3);
    values[2] = N1(xi_1)*N1(xi_2)*N2prime(xi_3);
  } else if(node == 4){
    values[0] = N2prime(xi_1)*N2(xi_2)*N1(xi_3);
    values[1] = N2(xi_1)*N2prime(xi_2)*N1(xi_3);
    values[2] = N2(xi_1)*N2(xi_2)*N1prime(xi_3);
  } else if(node == 5){
    values[0] = N2prime(xi_1)*N1(xi_2)*N2(xi_3);
    values[1] = N2(xi_1)*N1prime(xi_2)*N2(xi_3);
    values[2] = N2(xi_1)*N1(xi_2)*N2prime(xi_3);
  } else if(node == 6){
    values[0] = N1prime(xi_1)*N2(xi_2)*N2(xi_3);
    values[1] = N1(xi_1)*N2prime(xi_2)*N2(xi_3);
    values[2] = N1(xi_1)*N2(xi_2)*N2prime(xi_3);
  } else if(node == 7){
    values[0] = N2prime(xi_1)*N2(xi_2)*N2(xi_3);
    values[1] = N2(xi_1)*N2prime(xi_2)*N2(xi_3);
    values[2] = N2(xi_1)*N2(xi_2)*N2prime(xi_3);
  } 
...
void FEM<dim>::define_boundary_conds(){
  ...
  for(unsigned int i=0; i<totalNodes; i++){
    if(nodeLocation[i][0]==0){
      double y = nodeLocation[i][1], z = nodeLocation[i][2];
      boundary_values[i] = 300*(1+c0*(y+z));
    } else if(nodeLocation[i][0]==0.04){
      double y = nodeLocation[i][1], z = nodeLocation[i][2];
      boundary_values[i] = 310*(1+c0*(y+z));
    }
  }
}
...
void FEM<dim>::setup_system(){
  ...
  quad_points[0] = 0;
  quad_points[1] = -1./3.*sqrt(5-2*sqrt(10./7.)); //EDIT
  quad_points[2] = 1./3.*sqrt(5-2*sqrt(10./7.));
  quad_points[3] = -1./3.*sqrt(5+2*sqrt(10./7.)); //EDIT
  quad_points[4] = 1./3.*sqrt(5+2*sqrt(10./7.));


  quad_weight[0] = 128./225.; //EDIT
  quad_weight[1] = (322+13*sqrt(70))/900.; //EDIT
